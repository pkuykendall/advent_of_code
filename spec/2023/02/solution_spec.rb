...
RSpec.describe Year2023::Day02 do
  ...
  describe 'part 1' do
    ...
    it 'returns 2204 for my input' do
      expect(described_class.part_1(input)).to eq(2204)
    end
  end

  describe 'part 2' do
    it 'returns 2286 for the example input' do
      expect(described_class.part_2(example_input)).to eq(2286)
    end

    it 'returns 71036 for my input' do
      expect(described_class.part_2(input)).to eq(71_036)
    end
  end
end
